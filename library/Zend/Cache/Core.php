 ...
 * @version    $Id: smCore.php 23800 2011-03-10 20:52:08Z mabe $
 */
...
class Zend_Cache_Core
{
     ...
     * - If set to true, the smCore will set the ignore_user_abort PHP flag inside the
    ...
    /**
     * Not used for the smCore, just a sort a hint to get a common setOption() method (for the smCore and for frontends)
     *
     ...
     *
     * The new value is set for the smCore/frontend but for the backend too (directive)
     *
